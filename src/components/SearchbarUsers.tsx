...
const SearchbarUsers = ({ id, friends }: { id: string, friends: Array<number> }) => {
  ...
  return (
    <>
      <div className='position-relative' style={{ margin: "10px 25px" }}>
        ...
        <input type="text" className='search-bar fw-300 mx-auto' placeholder="Search for friends.." value={searchUser} onChange={handleSearch}>
        </input>
      </div>
      {searchUser != "" &&
        <>
