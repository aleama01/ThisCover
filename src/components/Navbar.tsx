      ...
      <div className='container-fluid'>
        <ul className="navbar-nav d-flex flex-row w-100 justify-content-around align-items-center">
          ...
          <li className="nav-item col">
            <a aria-current="page" href="/" className='active w-100 d-flex flex-column align-items-center nav-link'>
          ...
          <li className="nav-item col">
            <a href="/friends" className='w-100 d-flex flex-column align-items-center nav-link'>
          ...
          <li className="nav-item col">
            <a href="/account" className='d-flex flex-column align-items-center nav-link'>
