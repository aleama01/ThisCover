      ...
      <div className='container-fluid'>
        <ul className="navbar-nav d-flex flex-row w-100 justify-content-around align-items-center">
          ...
          <li className="nav-item col">
            <a href="/friends" className='w-100 d-flex flex-column align-items-center nav-link' onClick={() => setCurrentRoute(0)} style={{ color: currentRoute === 0 ? "#f1f1f1" : "#ababab" }}>
          ...
          <li className="nav-item col">
            <a aria-current="page" href="/" className='active w-100 d-flex flex-column align-items-center nav-link' onClick={() => setCurrentRoute(1)} style={{ color: currentRoute === 1 ? "#f1f1f1" : "#ababab" }}>
          ...
          <li className="nav-item col">
            <a href="/account" className='d-flex flex-column align-items-center nav-link' onClick={() => setCurrentRoute(2)} style={{ color: currentRoute === 2 ? "#f1f1f1" : "#ababab" }}>
